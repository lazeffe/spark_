          ...
          <div class="searchBar">
            <form action="/BoardSearch.bo">
              <div class="searchBar-items" id="searchBar-items">
                <button class="searchBar-icon" type="submit" id="search-btn"><i class="material-icons">search</i>
                </button>
                ...
                <div class="modal-body modal-body-borderless" id="${ cnt }">
                  ...
                  <div class="modal-body-right">
                    <div class="modal-body-icon">
                      <button onclick="deleteBmk('${ bmkName }', '${ cnt }', '${ first }', '${ last }')"><i class="material-icons">bookmark</i>
                      </button>
                    </div>
                  </div>
                </div>
